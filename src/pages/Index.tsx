    ...
    <MainLayout>
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <p className="text-xl text-gray-600 mb-8 max-w-lg">
                    Continue your career journey with personalized recommendations and AI-powered coaching.
                  </p>
                  <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                    <Button size="lg" className="bg-careerGpt-indigo hover:bg-careerGpt-indigo/90" onClick={handleGetStarted}>
                      Go to Dashboard
                    </Button>
                    <Button size="lg" variant="outline" onClick={() => navigate('/interviews')}>
                      Practice Interviews
                    </Button>
                  </div>
                </>
      ...
      {isAuthenticated ? (
        ...
        <section className="bg-gray-50 py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Personalized For You</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Based on your profile and career goals, we've curated these recommendations.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <RecommendationCard
                ...
                description="Your resume was last updated 30 days ago. Keep it current to maximize your opportunities."
                action="Upload Resume"
                onClick={() => navigate('/resumes')}
              />
              <RecommendationCard
                title="Practice for Your Next Interview"
                description="We've prepared customized interview questions for your target role."
                action="Start Practice"
                onClick={() => navigate('/interviews')}
              />
              <RecommendationCard
                title="Explore Job Matches"
                description="We found 6 new job matches that align with your skills and experience."
                action="View Jobs"
        ...
        /* Testimonials Section for Logged Out Users */
        <section className="bg-gray-50 py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
        ...
        <div className="container mx-auto px-4">
          <div className="bg-careerGpt-indigo rounded-xl shadow-xl p-10 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              {isAuthenticated ? 'Ready to Advance Your Career?' : 'Ready to Accelerate Your Career?'}
            </h2>
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              {isAuthenticated 
                ? 'Continue your journey with our AI-powered tools and expert guidance.' 
                : 'Join thousands of professionals using CareerGPT to find better jobs and advance their careers.'}
            </p>
            <Button 
              size="lg" 
              className="bg-white text-careerGpt-indigo hover:bg-gray-100" 
...
const RecommendationCard = ({ title, description, action, onClick }: RecommendationCardProps) => (
  <div className="career-card">
    <h3 className="text-xl font-semibold mb-2">{title}</h3>
