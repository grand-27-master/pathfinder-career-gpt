...
const ResumeCard = ({ title, lastUpdated, fileType }: ResumeCardProps) => (
  <Card>
...
const JobCard = ({ title, company, location, matchScore }: JobCardProps) => (
  <Card>
    <CardHeader className="pb-3">
    ...
    <CardFooter>
      <Button className="w-full bg-careerGpt-indigo hover:bg-careerGpt-indigo/90">View Job Details</Button>
    </CardFooter>
  </Card>
);
...
const InterviewItem = ({ title, date, status, score }: InterviewItemProps) => (
